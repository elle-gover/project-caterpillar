...
struct LifestagesDatabase {
    ...
    let lifestageOne = LifeStage(name: "Egg Stage",
                                 ...
                                 imgFile: "lifestage1",
                                 bulletPoints: ["The egg shape depends on the type of butterfly.", "If you look close enough you can actually see the tiny caterpillar growing inside of it."])
    
    let lifestageTwo = LifeStage(name: "Larva Stage",
                                 ...
                                 imgFile: "lifestage2",
                                 bulletPoints: ["When the egg hatches, the caterpillar will eat the start eating the leaf they born onto!", "The mother butterfly needs to pick the right type of leaf to lay her eggs on otherwise her baby will have nothing to eat!"])
    
    let lifestageThree = LifeStage(name: "Chrysalis Stage",
    ...
    let lifestageFour = LifeStage(name: "Adult Butterfly",
                                   food: "You don't wanna know",
